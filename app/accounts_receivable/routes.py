...
def _build_quote_pdf(quote, items):
    ...
    pdf.cell(80, 6, 'QUOTE', border=1, ln=True, align='R')
    pdf.set_font('Helvetica', 'B', 7)
    pdf.set_x(120)
    pdf.cell(20, 5, 'DATE', border=1, align='C')
    pdf.cell(30, 5, 'QUOTE NO.', border=1, align='C')
    pdf.cell(30, 5, 'VALID UNTIL', border=1, ln=True, align='C')
    pdf.set_font('Helvetica', '', 7)
    pdf.set_x(120)
    pdf.cell(20, 5, quote.date.strftime('%m/%d/%Y') if quote.date else '', border=1, align='C')
    pdf.cell(30, 5, _pdf_cell_text(quote.number), border=1, align='C')
    pdf.cell(30, 5, quote.valid_until.strftime('%m/%d/%Y') if quote.valid_until else '', border=1, ln=True, align='C')
...
def _build_invoice_pdf(invoice, items):
    ...
    pdf.cell(80, 6, 'Invoice', border=1, ln=True, align='R')
    pdf.set_font('Helvetica', 'B', 7)
    pdf.set_x(120)
    pdf.cell(26, 5, 'DATE', border=1, align='C')
    pdf.cell(54, 5, 'INVOICE NO.', border=1, ln=True, align='C')
    pdf.set_font('Helvetica', '', 7)
    pdf.set_x(120)
    pdf.cell(26, 5, invoice.date.strftime('%m/%d/%Y') if invoice.date else '', border=1, align='C')
    pdf.cell(54, 5, _pdf_cell_text(invoice.number), border=1, ln=True, align='C')
